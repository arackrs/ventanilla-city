...
namespace TF {
	...
	public ref class FrmLevel2 : public System::Windows::Forms::Form {
	...
	protected: ~FrmLevel2() { if (components)delete components; }
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void) {
			   ...
			   this->Timer100->Tick += gcnew System::EventHandler(this, &FrmLevel2::Timer100_Tick);
			   // 
			   // Timer1000
			   // 
			   this->Timer1000->Enabled = true;
			   this->Timer1000->Interval = 1000;
			   this->Timer1000->Tick += gcnew System::EventHandler(this, &FrmLevel2::Timer1000_Tick);
			   // 
			   // lblTimer
			   // 
			   ...
			   this->Text = L"Level1";
			   this->Load += gcnew System::EventHandler(this, &FrmLevel2::FrmLevel2_Load);
			   this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &FrmLevel2::FrmLevel2_KeyDown);
			   this->ResumeLayout(false);
			   this->PerformLayout();
		   }
#pragma endregion

	private: System::Void FrmLevel2_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void FrmLevel2_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
		switch (e->KeyCode) {
